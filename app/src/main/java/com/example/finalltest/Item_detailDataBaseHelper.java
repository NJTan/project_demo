...
public class Item_detailDataBaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String item_detail_sql="create table if not exists "+item_detail_table+"(ino integer primary key,Istate integer default 0, description text,start_real_time date default '0',end_real_time date default '0')";
